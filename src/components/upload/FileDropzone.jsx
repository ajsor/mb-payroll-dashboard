  ...
  return (
    <div className="flex flex-col">
      <div className="flex items-center gap-2 mb-2.5">
        ...
        <h3 className="text-sm font-medium text-gray-700 dark:text-slate-200 m-0">MindBody Payroll Report</h3>
      </div>
      <div
        {...getRootProps()}
          ...
          <div className="flex w-full flex-col items-center">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0 text-left">
                <p className="m-0 mb-0.5 break-words text-sm font-medium text-gray-900 dark:text-slate-100">{excelFile.name}</p>
                <p className="m-0 text-xs text-gray-500 dark:text-slate-400">{formatFileSize(excelFile.size)} - Click to replace</p>
              </div>
            </div>
          </div>
        ) : (
